(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const s of l)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function o(l){const s={};return l.integrity&&(s.integrity=l.integrity),l.referrerPolicy&&(s.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?s.credentials="include":l.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(l){if(l.ep)return;l.ep=!0;const s=o(l);fetch(l.href,s)}})();let f=20,b=0,m="stats";const g=["top","jungle","mid","bot","support"],$={top:"Top",jungle:"Jungle",mid:"Mid",bot:"Bot",support:"Support",flex:"Flex"},y={top:"🛡️",jungle:"🌿",mid:"⚡",bot:"🏹",support:"💙",flex:"🔀"},O={IRON:"#6a6a6a",BRONZE:"#a05000",SILVER:"#6a7f9a",GOLD:"#e5a330",PLATINUM:"#00b4b4",EMERALD:"#00c080",DIAMOND:"#576bce",MASTER:"#9d4dc6",GRANDMASTER:"#e84057",CHALLENGER:"#f4c874"},I={1:"I",2:"II",3:"III",4:"IV"},k={na1:"na",euw1:"euw",eune1:"eune",kr:"kr",br1:"br",la1:"lan",la2:"las",oc1:"oce",tr1:"tr",ru:"ru",jp1:"jp"};function L(e){return`https://www.op.gg/summoners/${k[e.region]??e.region.toLowerCase()}/${encodeURIComponent(e.gameName)}-${e.tagLine}`}function M(e){const t=I[e.division]??"";return`${e.tier.charAt(0)+e.tier.slice(1).toLowerCase()}${t?` ${t}`:""}`}function R(e){const t=e.wins+e.losses;return t?`${Math.round(e.wins/t*100)}%`:"0%"}function h(e){return e>=7?"#f4c874":e>=6?"#00c080":e>=5?"#4a9eff":e>=4?"#e5a330":"#e84057"}function w(e){const t=Math.floor((Date.now()-new Date(e).getTime())/6e4);if(t<1)return"just now";if(t<60)return`${t}m ago`;const o=Math.floor(t/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function S(e){const t={};for(const r of e)!r.position||r.opScore==null||(t[r.position]||(t[r.position]=[]),t[r.position].push(r.opScore));const o={};for(const[r,l]of Object.entries(t)){const s=l.reduce((a,n)=>a+n,0)/l.length;o[r]={avgOpScore:Math.round(s*100)/100,games:l.length}}return o}function C(e){if(e.opScore==null)return"";const t=e.result==="WIN",o=e.result==="WIN"?"win":e.result==="LOSE"?"loss":"",r=h(e.opScore),l=e.champion??"?",s=e.createdAt?new Date(e.createdAt).toLocaleDateString(void 0,{month:"short",day:"numeric"}):"";return`
    ...
    </div>`}function A(e,t,o){const r=e.rank?O[e.rank.tier]??"#888":"#555",l=h(o.avgOpScore),s=e.rank?`<div class="rank" style="color:${r}">
    ...
    <div class="card" id="card-${c}">
      ...
      ${s}
      ${n}
    </div>`}function N(e,t){const o=[...t].sort((r,l)=>l.score.avgOpScore-r.score.avgOpScore);return`
    <div class="column">
      ...
      ${o.length?o.map(({player:r,score:l})=>A(r,e,l)).join(""):'<div class="empty">No players</div>'}
    </div>`}function B(e,t){const o=e.map(a=>{const n=S(a.recentGames.slice(0,f));return g.flatMap(c=>{const i=n[c];return!i||i.games<t?[]:[{role:c,avgOpScore:i.avgOpScore,games:i.games}]})});let r=-1/0,l=new Map;function s(a,n,c,i){if(a===g.length){i>r&&(r=i,l=new Map(c));return}const p=g[a];s(a+1,n,c,i);for(let d=0;d<e.length;d++){if(n.has(d))continue;const u=o[d].find(E=>E.role===p);u&&(c.set(p,{player:e[d],score:u.avgOpScore,games:u.games}),n.add(d),s(a+1,n,c,i+u.avgOpScore),n.delete(d),c.delete(p))}}return s(0,new Set,new Map,0),g.map(a=>{const n=l.get(a);return n?{role:a,player:n.player,score:n.score,games:n.games}:{role:a,player:null,score:null,games:0}})}function G(e){return`
    ...
    </div>`}function j(e,t){const o=e.filter(s=>s.player).length,r=o?h(t/o):"#888",l=e.map(s=>{if(!s.player||s.score==null)return`
